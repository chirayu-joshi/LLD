...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //user1
        bookMyShow.createBooking(City.SURAT, "BAAHUBALI");
        //user2
        bookMyShow.createBooking(City.VADODARA, "BAAHUBALI");
    }
    ...
    private void createMovies() {
        ...
        movieController.addMovie(avengers, City.SURAT);
        movieController.addMovie(avengers, City.VADODARA);
        movieController.addMovie(baahubali, City.SURAT);
        movieController.addMovie(baahubali, City.VADODARA);
    }
    ...
    private void createTheatre() {
        ...
        inoxTheatre.setCity(City.SURAT);
        ...
        pvrTheatre.setCity(City.VADODARA);
        ...
        theatreController.addTheatre(inoxTheatre, City.SURAT);
        theatreController.addTheatre(pvrTheatre, City.VADODARA);
    }

    private Show createShows(int showId, Screen screen, Movie movie, int showStartTime) {
        Show show = new Show(showId, movie, screen, showStartTime, new ArrayList<>());
        return show;
    }
