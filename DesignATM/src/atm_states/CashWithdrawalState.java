...
import amount_withdrawal.CashWithdrawProcessor;
import amount_withdrawal.FiveHundredWithdrawProcessor;
import amount_withdrawal.OneHundredWithdrawProcessor;
import amount_withdrawal.TwoThousandWithdrawProcessor;
import atm.ATM;
import atm.Card;
...
public class CashWithdrawalState extends ATMState {
    ...
    public void cashWithdrawal(ATM atmObject, Card card, int withdrawalAmountRequest) {
        ...
        if (atmObject.getAtmBalance() < withdrawalAmountRequest) {
            System.out.println("Insufficient fund in the atm.ATM Machine");
            exit(atmObject);
